...
const Tabs = ({activeTabName, onClickTab}) => {
    const {CANCEL_AT_ANY_TIME,PICK_YOUR_PRICE,WATCH_ANYWHERE} = tabLable;
                    ...
                    <div className="tab-2-content-bottom">
                        <div>
                            ...
                            <p className='text-dark'>
                                Smart TVs, PlayStationm, Xbox, Chromecast, Apple TV, Blu-ray 
                                player and more
                            </p>
                        </div>
                        <div>
                            <img src='http://i.ibb.co/R3r1SPX/tab-content-2-2.png'
                            alt=''/>
                            <p className='text-md'>
                        ...
                        <div>
                            <img src='http://i.ibb.co/gDhnwWn/tab-content-2-3.png' 
                            alt=''/>
              ...
              className={`tab-content-item ${
                activeTabName===PICK_YOUR_PRICE && "show"}`}>
                    <div className="text-center">
                        <p className='text-lg'>
                            Choose one plan and watch everythings on Netflix
                        </p>
                        <Link to="/netflix-show" className='btn btn-lg'>
                            Watch Free For 30 Days
                        </Link>
